...
/* Punishments */
    ...
    $GLOBALS['trans'][1169] = 'Please confirm you wish to unpunish this player';
    $GLOBALS['trans'][1170] = 'Please confirm you wish to reinstate this punishment';
    $GLOBALS['trans'][1171] = 'Please confirm you wish to completely remove this punishment record from the database.';
    $GLOBALS['trans'][1172] = 'Location';
    $GLOBALS['trans'][1173] = 'Appeal status';
/* Servers */
    ...
    $GLOBALS['trans'][1206] = 'Loc';
    $GLOBALS['trans'][1207] = 'Time';
    $GLOBALS['trans'][1208] = 'Connect to: %s';
...
/* Appeals */
    ...
    $GLOBALS['trans'][1517] = 'Appeal status changed from \'%s\' to \'%s\' by %s.';
    $GLOBALS['trans'][1518] = 'Appeal';
    $GLOBALS['trans'][1519] = 'Please confirm you wish to completely remove this appeal record from the database.';
/* System */
    $GLOBALS['trans'][2001] = '';
...
/* Other */
    ...
    $GLOBALS['trans'][3014] = 'Please confirm your action';
    $GLOBALS['trans'][3015] = 'Confirm';
    $GLOBALS['trans'][3016] = 'Download attachment';
    $GLOBALS['trans'][3017] = 'Comments';
    $GLOBALS['trans'][3018] = 'Add comment';
    $GLOBALS['trans'][3019] = '.dem files only';
    $GLOBALS['trans'][3020] = 'View details';
?>